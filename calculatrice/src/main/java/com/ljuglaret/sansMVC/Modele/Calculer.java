package com.ljuglaret.sansMVC.Modele;
...
public class Calculer {
    ...
    private static Logger logger = LoggerFactory.getLogger(Calculer.class);

    private String expression;

    public Calculer(String expression) {
    ...
    public double evaluer() {
        ...
        expression = ajoutePlus(expression);
        logger.info("Chaîne à evaluer : " + expression);
